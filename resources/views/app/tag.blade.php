      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog <i class="ion-ios-arrow-forward"></i></span>
              <span>Tags <i class="ion-ios-arrow-forward"></i></span>
              <span>{{$name}} <i class="ion-ios-arrow-forward"></i></span>
            </p>
          </div>
        </div>
      </div>
		...
		<section class="ftco-section bg-light">
			<div class="container">
				<div class="row">
          @if($posts->count() == 0)
          <h4 class="text-center">Sorry! No Posts With This Tag Yet <a href="{{route('blog')}}">Back to Blog</a></h4>
          @else
