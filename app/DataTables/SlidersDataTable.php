    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($object) {
                $actions = '<a href="'. route("slider.edit", [$object->id]) .'" class="btn btn-sm btn-outline-success"><i class="far fa-edit"></i></a>&nbsp;';
                $actions .= '<a href="'. route("slider.delete", [$object->id]) .'" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></a>';
