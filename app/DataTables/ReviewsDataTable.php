    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($object) {
                $actions = '<a href="'. route("parent.edit", [$object->id]) .'" class="btn btn-outline-success"><i class="far fa-edit"></i></a>&nbsp;';
                $actions .= '<a href="'. route("parent.delete", [$object->id]) .'" class="btn btn-outline-danger"><i class="fa fa-trash"></i></a>';
